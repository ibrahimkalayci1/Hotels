...
//api den lokasyon verilerini aldık
...
//otellerin lokasyonlarından oluşan BENZERSİZ elemanlara sahip 
// bir dizi oluşturduk
  ...
  return (
    <form className="lg:mt-28 flex flex-col gap-4 lg:gap-10">
      <div className="flex flex-col gap-2">
        ...
        defaultValue={params.get("location") || undefined }
        >
      ...
      <div className="flex flex-col gap-2">
        <label className="font-bold">Konaklama yeri adına göre
          ara </label>
    ...
    <div className="flex justify-end">
      ...
      type="reset"
      onClick={handleReset } 
      className="bg-blue-500 p-1 px-4 text-white 
      rounded-md w-fit">
        Filtreleri Temizle
